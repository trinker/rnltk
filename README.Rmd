...
packs <- c(na.omit(unlist(qdapRegex::ex_between(packs, '"', '"'))))
...
There are plans to add to this list including outside packages, focusing particularly on machine learning/classification packages.
